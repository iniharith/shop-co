      ...
      <div className="relative z-20 flex flex-col items-start text-left px-6 sm:px-10 md:px-16 lg:px-20 pb-16 sm:pb-20 md:pb-24 w-full max-w-4xl">
        ...
        >
          <button
            ...
            className="inline-flex items-center justify-center px-7 sm:px-8 py-3.5 sm:py-4 bg-brand-highlight text-[#171717] font-semibold text-xs sm:text-sm tracking-normal rounded-full hover:bg-[#f4b400] dark:hover:bg-[#ffc52e] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg cursor-pointer"
          >
