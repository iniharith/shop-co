  ...
  return (
    <main className={`${styles.invitation} ${coverState !== "open" ? styles.opened : ""} rsvp-page`} onClick={handleContentClick}>
      ...
      <section className={`${styles.details} ${styles.reveal}`} data-reveal id="majlis">
        ...
        <p className={styles.detailsIntro}><span>Assalamualaikum wbr &amp; Salam Sejahtera</span><span>dengan penuh kesyukuran dan keredaan-Nya, Saya</span></p>
        <div className={styles.hostNames}><strong>NASIR BIN IBRAHIM</strong><span>&amp;</span><strong>FATAHIAH BINTI MAT IDRIS</strong></div>
