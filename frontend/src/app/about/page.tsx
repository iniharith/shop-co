        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
              className="order-2 md:order-1 bg-[#D4AF37]/5 flex items-center justify-center p-12 rounded-3xl"
            >
               <Image
                src="/images/kampung-cetak-logo.png"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="bg-[#D4AF37]/10 text-[#D4AF37] w-12 h-12 rounded-full flex items-center justify-center mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold mb-8 text-[#D4AF37]">Our Mission</h2>
            ...
            >
              <h2 className="text-4xl font-bold mb-6 text-[#D4AF37]">Our Vision</h2>
