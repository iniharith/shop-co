  ...
  return (
    <main className="min-h-screen bg-[#f7f3e9] text-[#101820] dark:bg-background dark:text-foreground">
      <section className="relative overflow-hidden border-b border-[#d9cfba] bg-[#101820] dark:bg-card dark:border-border dark:text-foreground px-4 py-16 text-white sm:px-6 sm:py-24 lg:px-8">
        <div className="pointer-events-none absolute -right-28 -top-32 size-[32rem] rounded-full bg-[#f4b400]/10 dark:bg-foreground/5 blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        <div className="mb-8 flex items-end justify-between gap-6">
          <div><p className="store-eyebrow mb-2 text-[#80620a] dark:text-muted-foreground">Nationwide network</p><h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">Trusted delivery partners</h2></div>
        ...
        <section className="mt-14 overflow-hidden rounded-[1.5rem] border border-[#d9cfba] bg-[#101820] dark:bg-card dark:border-border dark:text-foreground p-7 text-white shadow-[0_30px_80px_-55px_rgba(16,24,32,0.9)] sm:mt-20 md:p-12">
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 md:grid-cols-2">
              {copy.details.map(([title, description], index) => (
                <div key={title} className="bg-[#101820] dark:bg-card dark:border-border dark:text-foreground p-6 sm:p-8">
