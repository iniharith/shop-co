...
export const products = [
  {
    _id: 101,
    name: "Custom Print Banner (Mockup)",
    price: 45,
    originalPrice: 50,
    rating: 5,
    images: ["/images/kampung-cetak-logo.png"],
    discount: 10,
    description: "High quality custom printed banner. Fake mockup item to fill the category.",
    category: "banner",
  ...
  {
    _id: 102,
    name: "Corporate Flyers (Mockup)",
    price: 25,
    originalPrice: 30,
    rating: 4.5,
    images: ["/images/kampung-cetak-logo.png"],
    discount: 0,
    description: "A stack of 1000 printed flyers. Fake mockup item to fill the category.",
    category: "flyers",
    sizes: [{ size: "A4", stock: 100 }, { size: "A5", stock: 100 }],
    printingOptions: [],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    _id: 103,
    name: "Personalised Mug (Mockup)",
    price: 15,
    originalPrice: 18,
    rating: 4.8,
    images: ["/images/kampung-cetak-logo.png"],
    discount: 5,
    description: "Custom printed corporate mug. Fake mockup item to fill the category.",
    category: "mug",
    sizes: [{ size: "Standard", stock: 100 }],
    printingOptions: [],
    createdAt: new Date(),
