...
export default function CatalogPage() {
  ...
  return (
    <main className="space-y-6 p-4 md:p-8">
      ...
      {section === 'archived' && selected.length > 0 && (
        <div className="flex items-center justify-between rounded-xl border border-red-500/20 bg-red-500/5 p-4">
          <p className="text-sm text-red-700 dark:text-red-300">Archived products can be permanently deleted and cannot be restored.</p>
          <Button size="sm" variant="destructive" onClick={() => void bulkDelete()}><Trash2 className="mr-1 h-4 w-4" /> Delete archived permanently</Button>
        </div>
      )}
