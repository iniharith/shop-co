...
export default function SearchResultsPage() {
  ...
  const { data: tasksData, isPending: isLoadingTasks } = useTasks({ statuses: "PLACED,IN_PROGRESS,PENDING_ARTWORK,ARTWORK_REVIEWED,ARTWORK_REJECTED,IN_DESIGN,PEMBETULAN,DONE_DESIGN,IN_PRODUCTION,HOLD_PRINTING,DONE_PRINTING,PACKAGING,SHIPPED,IN_TRANSIT,DELIVERED,CANCELLED,FAILED" });
  ...
  return (
    <PageContainer scrollable={true}>
      <div className="flex flex-1 flex-col space-y-6 bg-background/40 backdrop-blur-md border border-white/10 p-6 rounded-2xl shadow-xl">
