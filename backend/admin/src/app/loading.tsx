  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background/95 backdrop-blur-md overflow-hidden">
      ...
      <div className="mt-12 flex flex-col items-center">
        <h2 className="text-xl font-bold tracking-[0.3em] text-foreground uppercase animate-pulse">
          Processing
        </h2>
        <div className="mt-4 flex items-center gap-1 opacity-70">
          <span className="text-xs font-mono text-primary tracking-widest">SYSTEM</span>
