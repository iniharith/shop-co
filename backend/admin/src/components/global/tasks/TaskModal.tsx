    ...
    <div className="relative group w-fit max-w-[90%] sm:max-w-[80%] mb-5 mt-1 mx-auto sm:mx-0">
      ...
      <div className="absolute -bottom-3.5 left-1/2 -translate-x-1/2 z-20 shadow-md bg-[#fde047] rounded-[8px] flex items-center w-[70%] transition-all focus-within:ring-2 focus-within:ring-white">
        <Input 
          ...
          className="bg-transparent border-0 text-black placeholder:text-black/60 font-medium h-7 px-2 w-full focus-visible:ring-0 focus-visible:ring-offset-0 text-[10px]"
        />
